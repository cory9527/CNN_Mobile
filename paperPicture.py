...
# 应用转换并显示每一步的结果
def show_transforms(image_path, transform):
...
def show_mixup(image_path, target_path, labels, mixup_fn):
    image1 = show_transforms(image_path, transformList)
    image2 = show_transforms(target_path, transformList)
...
if __name__ == '__main__':
    # 测试方法
    # 使用Pillow库读取图像
    image_path = f"F:/wei/NN-MOBILENET/dataset/APOTS/crop/train_images3/0a4e1a29ffff.png"
    target_path = f"F:/wei/NN-MOBILENET/dataset/APOTS/crop/train_images3/0a9ec1e99ce4.png"
