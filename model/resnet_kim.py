...
class LinearBottleneck(nn.Module):
    def __init__(self, in_channels, channels, t, stride, use_se=True, se_ratio=12, dropout=0.0, use_cbam=True, **kwargs):
...
class ReXNetCBAM(nn.Module):
    def __init__(self, input_ch=16, final_ch=180, width_mult=1.0, depth_mult=1.0, classes=1000,
                 use_se=True, se_ratio=12, dropout_ratio=0.2, drop_path=0.25, bn_momentum=0.9, use_cbam=True):
        super(ReXNetCBAM, self).__init__()
        ...
        for block_idx, (in_c, c, t, s, se) in enumerate(zip(in_channels_group, channels_group, ts, strides, use_ses)):
            features.append(LinearBottleneck(in_channels=in_c,
                                             ...
                                             t=t,
                                             stride=s,
                                             use_se=se, se_ratio=se_ratio, dropout=drop_path, use_cbam=use_cbam))
...
if __name__ == '__main__':
    model = ReXNetCBAM(width_mult=1.0, classes=5, use_cbam=True)
