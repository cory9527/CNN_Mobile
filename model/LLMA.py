...
class MLLAttention(nn.Module):
    ...
    def __init__(self, dim=3, input_resolution=[160, 160], num_heads=2, qkv_bias=True, **kwargs):
        super().__init__()
        self.dim = dim
...
if __name__ == "__main__":
    ...
    # image_size = (8, 48, 8, 8)
    image_size = (32, 694, 7, 7)
    image = torch.rand(*image_size)
    # Model
    model = MLLAttention(694) #MLLA
    # model = MKLAttention(48) # MKLA
    out = model(image)
    print(out.size())
    # f, t = profile(model, inputs=(image,))
    # f, t = clever_format([f, t], "%.3f")
    # print(f, t)
